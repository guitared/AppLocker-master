package com.nomorerowk.androidlib;
...
class ShareManager {
	...
	private static final String PREF_FILE = "org.nomorerowk.androidlib.share";
	private static final String PREF_KEY_COUNT = "org.nomorerowk.androidlib.share.count";
	/**
	 * After how many times should the share dialog be shown for the first time?
	 */
	private static final String PREF_KEY_OFFSET = "org.nomorerowk.androidlib.share.offset";
	/** After the first time, each how many times should the dialog show? */
	private static final String PREF_KEY_REPEAT = "org.nomorerowk.androidlib.share.repeat";
	private static final int OFFSET_DEFAULT = 7;
	private static final int REPEAT_DEFAULT = 5;

	private static final String PREF_KEY_NEVER = "org.nomorerowk.androidlib.share.never";
